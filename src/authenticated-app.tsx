        ...
        <Main>
            <Router>
                <Routes>
                    ...
                    <Route index element={<ProjectListScreen setProjectModalOpen={setProjectModalOpen} />}></Route>
                </Routes>
            </Router> 
        </Main>
        <ProjectModal projetModalOpen={projectModalOpen} onClose={() => setProjectModalOpen(false)} />
    </Container>
}
